"""Regularisation and shrinkage - LASSO
This module attempts to improve on the OLS predictions by using regularisation
and coefficient shrinkage using LASSO Regression. Regularisation is a technique
...
def main():
    ...
    # LASSO regression model with regularisation parameter 0.1
    ...
    print(f'Mean squared error on training data: '
          f'{mean_squared_error(y_train, lasso.predict(x_train))}')
    # Explained variance score: 1 is perfect prediction
    print(f'Variance score on training data: '
          f'{r2_score(y_train, lasso.predict(x_train))}')
    # Evaluate model on test data
    print(f'Mean squared error on test data: '
          f'{mean_squared_error(y_test, lasso.predict(x_test))}')
    # Explained variance score: 1 is perfect prediction
    print(f'Variance score on test data: '
          f'{r2_score(y_test, lasso.predict(x_test))}')
