"""Trend following strategy using volatility adjusted APO trading signal.
...
will perform buy trades when the APO signal value is above +10 and perform
sell trades when the APO signal value drops below -10. It will check that new
